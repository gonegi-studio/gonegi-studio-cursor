...
import {
  ...
  writeTitanicMotionReconstruction,
} from '../services/titanicMotionReconstruction.js';
...
const report = writeTitanicMotionReconstruction(projectRoot);
...
if (report.final_verdict !== TITANIC_MOTION_PASS_VERDICT) {
  console.error('TITANIC MOTION RECONSTRUCTION FAILED');
