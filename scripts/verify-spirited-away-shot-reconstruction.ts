...
import {
  ...
  writeSpiritedAwayShotReconstruction,
} from '../services/spiritedAwayShotReconstruction.js';
...
const report = writeSpiritedAwayShotReconstruction(projectRoot);
...
if (report.final_verdict !== SPIRITED_AWAY_SHOT_PASS_VERDICT) {
  console.error('SPIRITED AWAY SHOT RECONSTRUCTION FAILED');
