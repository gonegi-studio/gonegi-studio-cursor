...
import {
  VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_PASS_VERDICT,
  VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_REPORT_PATH,
} from './verticalAiOpportunityIdentificationV14Engine.js';
import {
...
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_PHASE =
  'PHASE-VERTICAL-AI-OPPORTUNITY-IDENTIFICATION-V15' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_PASS_VERDICT =
  'PASS_VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_FAIL_VERDICT =
  'FAIL_VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_STATUS =
  'VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_COMPLETE' as const;

export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_DIR =
  'datasets/stage7/vertical_ai_opportunity_identification_v15' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_DIR}/vertical-ai-opportunity-identification-v15.json` as const;
export const VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V15_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_DIR}/vertical-ai-project-truth-resolution-v15.json` as const;
export const VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V15_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_DIR}/vertical-ai-brain-assist-evidence-v15.json` as const;
export const VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V15_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_DIR}/vertical-ai-domain-opportunity-scores-v15.json` as const;
export const VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V15_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_DIR}/vertical-ai-selected-domain-opportunity-v15.json` as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_REPORT_PATH =
  'reports/stage7/VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_REPORT.json' as const;

export const VAOI15_CONTRACT_IDS = [
  'VAOI15_V14_PREREQUISITE_RESOLVED',
  'VAOI15_REINVESTMENT_COMPLETION_INTEGRATED',
  'VAOI15_PROJECT_TRUTH_RESOLVED',
  'VAOI15_BRAIN_ASSIST_EVIDENCE_PRESENT',
  'VAOI15_DOMAIN_SCORES_COMPUTED',
  'VAOI15_DOMAIN_CERTIFICATIONS_INTEGRATED',
  'VAOI15_HIGHEST_VALUE_DOMAIN_SELECTED',
  'VAOI15_EVIDENCE_BASED_DECISION',
] as const;
...
const EXECUTION_FLAGS = {
  vertical_ai_opportunity_identification_v15: true as const,
...
function validateContracts(input: {
  v14PrerequisiteResolved: boolean;
  ...
  const results = [
    {
      contract_id: 'VAOI15_V14_PREREQUISITE_RESOLVED',
      verdict: input.v14PrerequisiteResolved ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI15_REINVESTMENT_COMPLETION_INTEGRATED',
      verdict: input.reinvestmentCompletionIntegrated ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI15_PROJECT_TRUTH_RESOLVED',
      verdict: input.projectTruthResolved ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI15_BRAIN_ASSIST_EVIDENCE_PRESENT',
      verdict: input.brainAssistEvidencePresent ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI15_DOMAIN_SCORES_COMPUTED',
      verdict: input.domainScoresComputed ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI15_DOMAIN_CERTIFICATIONS_INTEGRATED',
      verdict: input.domainCertificationsIntegrated ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI15_HIGHEST_VALUE_DOMAIN_SELECTED',
      verdict: input.highestValueDomainSelected ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI15_EVIDENCE_BASED_DECISION',
...
export function writeVerticalAiOpportunityIdentificationV15EngineReport(): {
  passed: boolean;
  verdict: string;
  reportPath: string;
  selectedDomainId: string | null;
  ...
  const v14PrerequisiteResolved = phaseReportPassed(
    root,
    VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_REPORT_PATH,
    VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_PASS_VERDICT
  );
  if (!v14PrerequisiteResolved) {
    issues.push({
      code: 'PREREQ',
      message: 'PASS_VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14 required',
      severity: 'error',
    });
  }
  ...
  const precheckPassed =
    v14PrerequisiteResolved && ontologyExists && capabilityModelExists && goalModelExists && lpmExists;
  ...
  if (precheckPassed) {
    ...
    writeJson(root, VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V15_PATH, {
      vertical_ai_project_truth_resolution_v15_id: 'vertical_ai_project_truth_resolution_v15',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_PHASE,
      ...
      vertical_ai_opportunity_identification_v14_prerequisite: v14PrerequisiteResolved,
      vertical_ai_opportunity_identification_v14_report_ref:
        VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_REPORT_PATH,
    });

    writeJson(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V15_PATH, {
      vertical_ai_brain_assist_evidence_v15_id: 'vertical_ai_brain_assist_evidence_v15',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    writeJson(root, VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V15_PATH, {
      vertical_ai_domain_opportunity_scores_v15_id: 'vertical_ai_domain_opportunity_scores_v15',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    writeJson(root, VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V15_PATH, {
      vertical_ai_selected_domain_opportunity_v15_id: 'vertical_ai_selected_domain_opportunity_v15',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    contractValidation = validateContracts({
      v14PrerequisiteResolved,
      reinvestmentCompletionIntegrated,
      projectTruthResolved: goalTruth.evaluated_goals > 0,
      brainAssistEvidencePresent: pathExists(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V15_PATH),
    ...
    if (contractValidation.aggregate_verdict !== 'PASS') {
      issues.push({
        ...
        message: 'One or more VAOI15 contracts failed',
        severity: 'error',
      });
    }
  }
  ...
  const verdict = passed
    ...
    : VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_FAIL_VERDICT;

  writeJson(root, VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_PATH, {
    vertical_ai_opportunity_identification_v15_id: 'vertical_ai_opportunity_identification_v15',
    architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
    phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_PHASE,
    generated_at: generatedAt,
    mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    decision_fingerprint: decisionFingerprint,
    selected_domain_id: selectedDomain?.domain_id ?? null,
    project_truth_ref: VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V15_PATH,
    brain_assist_evidence_ref: VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V15_PATH,
    domain_scores_ref: VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V15_PATH,
    selected_domain_ref: VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V15_PATH,
    lpm_mutation: false,
    brain_modification: false,
  });

  const report = {
    report_id: `vertical_ai_opportunity_identification_v15_${Date.now()}`,
    phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_PHASE,
    generated_at: generatedAt,
    mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    cycle_context: 'IMPLEMENTATION_CYCLE',
    goal: 'Select the highest-value eligible Vertical AI reinvestment domain.',
    vertical_ai_opportunity_identification_v15_passed: passed,
    final_verdict: verdict,
    status: passed
      ? VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_STATUS
      : 'VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_FAILED',
    decision_fingerprint: decisionFingerprint,
    ...
    domain_scores_ref: VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V15_PATH,
    selected_domain_ref: VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V15_PATH,
    identification_ref: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_PATH,
    domain_certifications: domainCertifications,
    reinvestment_completions: reinvestmentCompletions,
    ...
    checks: {
      ...
      V14_PREREQUISITE: v14PrerequisiteResolved,
      ...
      BRAIN_ASSIST_EVIDENCE_PRESENT: pathExists(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V15_PATH),
  ...
  writeJson(root, VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_REPORT_PATH, report);

  return {
    passed,
    verdict,
    reportPath: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V15_REPORT_PATH,
    selectedDomainId: selectedDomain?.domain_id ?? null,
  };
}
