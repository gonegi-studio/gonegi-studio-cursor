...
import {
  VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_PASS_VERDICT,
  VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_REPORT_PATH,
} from './verticalAiOpportunityIdentificationV13Engine.js';
import {
...
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_PHASE =
  'PHASE-VERTICAL-AI-OPPORTUNITY-IDENTIFICATION-V14' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_PASS_VERDICT =
  'PASS_VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_FAIL_VERDICT =
  'FAIL_VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_STATUS =
  'VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_COMPLETE' as const;

export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_DIR =
  'datasets/stage7/vertical_ai_opportunity_identification_v14' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_DIR}/vertical-ai-opportunity-identification-v14.json` as const;
export const VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V14_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_DIR}/vertical-ai-project-truth-resolution-v14.json` as const;
export const VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V14_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_DIR}/vertical-ai-brain-assist-evidence-v14.json` as const;
export const VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V14_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_DIR}/vertical-ai-domain-opportunity-scores-v14.json` as const;
export const VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V14_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_DIR}/vertical-ai-selected-domain-opportunity-v14.json` as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_REPORT_PATH =
  'reports/stage7/VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_REPORT.json' as const;

export const VAOI14_CONTRACT_IDS = [
  'VAOI14_V13_PREREQUISITE_RESOLVED',
  'VAOI14_REINVESTMENT_COMPLETION_INTEGRATED',
  'VAOI14_PROJECT_TRUTH_RESOLVED',
  'VAOI14_BRAIN_ASSIST_EVIDENCE_PRESENT',
  'VAOI14_DOMAIN_SCORES_COMPUTED',
  'VAOI14_DOMAIN_CERTIFICATIONS_INTEGRATED',
  'VAOI14_HIGHEST_VALUE_DOMAIN_SELECTED',
  'VAOI14_EVIDENCE_BASED_DECISION',
] as const;
...
const EXECUTION_FLAGS = {
  vertical_ai_opportunity_identification_v14: true as const,
...
function validateContracts(input: {
  v13PrerequisiteResolved: boolean;
  ...
  const results = [
    {
      contract_id: 'VAOI14_V13_PREREQUISITE_RESOLVED',
      verdict: input.v13PrerequisiteResolved ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI14_REINVESTMENT_COMPLETION_INTEGRATED',
      verdict: input.reinvestmentCompletionIntegrated ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI14_PROJECT_TRUTH_RESOLVED',
      verdict: input.projectTruthResolved ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI14_BRAIN_ASSIST_EVIDENCE_PRESENT',
      verdict: input.brainAssistEvidencePresent ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI14_DOMAIN_SCORES_COMPUTED',
      verdict: input.domainScoresComputed ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI14_DOMAIN_CERTIFICATIONS_INTEGRATED',
      verdict: input.domainCertificationsIntegrated ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI14_HIGHEST_VALUE_DOMAIN_SELECTED',
      verdict: input.highestValueDomainSelected ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI14_EVIDENCE_BASED_DECISION',
...
export function writeVerticalAiOpportunityIdentificationV14EngineReport(): {
  passed: boolean;
  verdict: string;
  reportPath: string;
  selectedDomainId: string | null;
  ...
  const v13PrerequisiteResolved = phaseReportPassed(
    root,
    VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_REPORT_PATH,
    VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_PASS_VERDICT
  );
  if (!v13PrerequisiteResolved) {
    issues.push({
      code: 'PREREQ',
      message: 'PASS_VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13 required',
      severity: 'error',
    });
  }
  ...
  const precheckPassed =
    v13PrerequisiteResolved && ontologyExists && capabilityModelExists && goalModelExists && lpmExists;
  ...
  if (precheckPassed) {
    ...
    writeJson(root, VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V14_PATH, {
      vertical_ai_project_truth_resolution_v14_id: 'vertical_ai_project_truth_resolution_v14',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_PHASE,
      ...
      vertical_ai_opportunity_identification_v13_prerequisite: v13PrerequisiteResolved,
      vertical_ai_opportunity_identification_v13_report_ref:
        VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_REPORT_PATH,
    });

    writeJson(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V14_PATH, {
      vertical_ai_brain_assist_evidence_v14_id: 'vertical_ai_brain_assist_evidence_v14',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    writeJson(root, VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V14_PATH, {
      vertical_ai_domain_opportunity_scores_v14_id: 'vertical_ai_domain_opportunity_scores_v14',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    writeJson(root, VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V14_PATH, {
      vertical_ai_selected_domain_opportunity_v14_id: 'vertical_ai_selected_domain_opportunity_v14',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    contractValidation = validateContracts({
      v13PrerequisiteResolved,
      reinvestmentCompletionIntegrated,
      projectTruthResolved: goalTruth.evaluated_goals > 0,
      brainAssistEvidencePresent: pathExists(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V14_PATH),
    ...
    if (contractValidation.aggregate_verdict !== 'PASS') {
      issues.push({
        ...
        message: 'One or more VAOI14 contracts failed',
        severity: 'error',
      });
    }
  }
  ...
  const verdict = passed
    ...
    : VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_FAIL_VERDICT;

  writeJson(root, VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_PATH, {
    vertical_ai_opportunity_identification_v14_id: 'vertical_ai_opportunity_identification_v14',
    architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
    phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_PHASE,
    generated_at: generatedAt,
    mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    decision_fingerprint: decisionFingerprint,
    selected_domain_id: selectedDomain?.domain_id ?? null,
    project_truth_ref: VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V14_PATH,
    brain_assist_evidence_ref: VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V14_PATH,
    domain_scores_ref: VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V14_PATH,
    selected_domain_ref: VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V14_PATH,
    lpm_mutation: false,
    brain_modification: false,
  });

  const report = {
    report_id: `vertical_ai_opportunity_identification_v14_${Date.now()}`,
    phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_PHASE,
    generated_at: generatedAt,
    mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    cycle_context: 'IMPLEMENTATION_CYCLE',
    goal: 'Select the highest-value eligible Vertical AI reinvestment domain.',
    vertical_ai_opportunity_identification_v14_passed: passed,
    final_verdict: verdict,
    status: passed
      ? VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_STATUS
      : 'VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_FAILED',
    decision_fingerprint: decisionFingerprint,
    ...
    domain_scores_ref: VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V14_PATH,
    selected_domain_ref: VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V14_PATH,
    identification_ref: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_PATH,
    domain_certifications: domainCertifications,
    reinvestment_completions: reinvestmentCompletions,
    ...
    checks: {
      ...
      V13_PREREQUISITE: v13PrerequisiteResolved,
      ...
      BRAIN_ASSIST_EVIDENCE_PRESENT: pathExists(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V14_PATH),
  ...
  writeJson(root, VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_REPORT_PATH, report);

  return {
    passed,
    verdict,
    reportPath: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V14_REPORT_PATH,
    selectedDomainId: selectedDomain?.domain_id ?? null,
  };
}
