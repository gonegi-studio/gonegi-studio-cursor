...
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_PHASE =
  'PHASE-VERTICAL-AI-OPPORTUNITY-IDENTIFICATION-V10' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_PASS_VERDICT =
  'PASS_VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_FAIL_VERDICT =
  'FAIL_VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_STATUS =
  'VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_COMPLETE' as const;

export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_DIR =
  'datasets/stage7/vertical_ai_opportunity_identification_v10' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_DIR}/vertical-ai-opportunity-identification-v10.json` as const;
export const VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V10_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_DIR}/vertical-ai-project-truth-resolution-v10.json` as const;
export const VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V10_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_DIR}/vertical-ai-brain-assist-evidence-v10.json` as const;
export const VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V10_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_DIR}/vertical-ai-domain-opportunity-scores-v10.json` as const;
export const VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V10_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_DIR}/vertical-ai-selected-domain-opportunity-v10.json` as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_REPORT_PATH =
  'reports/stage7/VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_REPORT.json' as const;

export const VAOI10_CONTRACT_IDS = [
  'VAOI10_PROJECT_TRUTH_RESOLVED',
  'VAOI10_BRAIN_ASSIST_EVIDENCE_PRESENT',
  'VAOI10_DOMAIN_SCORES_COMPUTED',
  'VAOI10_DOMAIN_CERTIFICATIONS_INTEGRATED',
  'VAOI10_HIGHEST_VALUE_DOMAIN_SELECTED',
  'VAOI10_EVIDENCE_BASED_DECISION',
] as const;
...
const EXECUTION_FLAGS = {
  vertical_ai_opportunity_identification_v10: true as const,
...
function validateContracts(input: {
  ...
  const results = [
    {
      contract_id: 'VAOI10_PROJECT_TRUTH_RESOLVED',
      verdict: input.projectTruthResolved ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI10_BRAIN_ASSIST_EVIDENCE_PRESENT',
      verdict: input.brainAssistEvidencePresent ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI10_DOMAIN_SCORES_COMPUTED',
      verdict: input.domainScoresComputed ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI10_DOMAIN_CERTIFICATIONS_INTEGRATED',
      verdict: input.domainCertificationsIntegrated ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI10_HIGHEST_VALUE_DOMAIN_SELECTED',
      verdict: input.highestValueDomainSelected ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI10_EVIDENCE_BASED_DECISION',
...
export function writeVerticalAiOpportunityIdentificationV10EngineReport(): {
  passed: boolean;
  verdict: string;
  reportPath: string;
  selectedDomainId: string | null;
  ...
  if (precheckPassed) {
    ...
    writeJson(root, VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V10_PATH, {
      vertical_ai_project_truth_resolution_v10_id: 'vertical_ai_project_truth_resolution_v10',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_PHASE,
    ...
    writeJson(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V10_PATH, {
      vertical_ai_brain_assist_evidence_v10_id: 'vertical_ai_brain_assist_evidence_v10',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    const eligibleDomains =
      primaryEligibleDomains.length > 0 ? primaryEligibleDomains : fallbackEligibleDomains;
    ...
    writeJson(root, VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V10_PATH, {
      vertical_ai_domain_opportunity_scores_v10_id: 'vertical_ai_domain_opportunity_scores_v10',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    writeJson(root, VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V10_PATH, {
      vertical_ai_selected_domain_opportunity_v10_id: 'vertical_ai_selected_domain_opportunity_v10',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
      ...
      rationale: selectedDomain
        ? `${selectedDomain.domain_id} is the highest-value eligible Vertical AI domain by goal alignment (${selectedDomain.goal_alignment_score}), entity scale (${selectedDomain.entity_scale_score}), and dependency readiness (${selectedDomain.dependency_readiness_score}), excluding domain-certified domains${primaryEligibleDomains.length === 0 ? ' (fallback among developed-uncertified domains)' : ''}.`
    ...
    contractValidation = validateContracts({
      ...
      brainAssistEvidencePresent: pathExists(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V10_PATH),
    ...
    if (contractValidation.aggregate_verdict !== 'PASS') {
      issues.push({
        ...
        message: 'One or more VAOI10 contracts failed',
        severity: 'error',
      });
    }
  }
  ...
  const verdict = passed
    ? VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_PASS_VERDICT
    : VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_FAIL_VERDICT;

  writeJson(root, VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_PATH, {
    vertical_ai_opportunity_identification_v10_id: 'vertical_ai_opportunity_identification_v10',
    architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
    phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_PHASE,
    generated_at: generatedAt,
    mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    decision_fingerprint: decisionFingerprint,
    selected_domain_id: selectedDomain?.domain_id ?? null,
    project_truth_ref: VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V10_PATH,
    brain_assist_evidence_ref: VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V10_PATH,
    domain_scores_ref: VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V10_PATH,
    selected_domain_ref: VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V10_PATH,
    lpm_mutation: false,
    brain_modification: false,
  });

  const report = {
    report_id: `vertical_ai_opportunity_identification_v10_${Date.now()}`,
    phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_PHASE,
    generated_at: generatedAt,
    mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    cycle_context: 'IMPLEMENTATION_CYCLE',
    goal: 'Select the highest-value eligible Vertical AI domain.',
    vertical_ai_opportunity_identification_v10_passed: passed,
    final_verdict: verdict,
    status: passed
      ? VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_STATUS
      : 'VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_FAILED',
    decision_fingerprint: decisionFingerprint,
    ...
    eligible_domain_count: (() => {
      ...
      return primaryCount > 0
        ? primaryCount
        : domainScores.filter((score) => !score.domain_certified).length;
    })(),
    domain_certified_count: domainScores.filter((score) => score.domain_certified).length,
    project_truth_ref: VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V10_PATH,
    brain_assist_evidence_ref: VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V10_PATH,
    domain_scores_ref: VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V10_PATH,
    selected_domain_ref: VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V10_PATH,
    identification_ref: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_PATH,
    domain_certifications: domainCertifications,
    ...
    top_eligible_domains: (() => {
      ...
      const pool =
        primary.length > 0
          ? primary
          : domainScores.filter((score) => !score.domain_certified);
      return pool
    ...
    checks: {
      ...
      BRAIN_ASSIST_EVIDENCE_PRESENT: pathExists(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V10_PATH),
  ...
  writeJson(root, VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_REPORT_PATH, report);

  return {
    passed,
    verdict,
    reportPath: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V10_REPORT_PATH,
    selectedDomainId: selectedDomain?.domain_id ?? null,
  };
}
