...
import {
  ...
  VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V16_REPORT_PATH,
} from './verticalAiOpportunityIdentificationV16Engine.js';
import {
...
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_PHASE =
  'PHASE-VERTICAL-AI-OPPORTUNITY-IDENTIFICATION-V17' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_PASS_VERDICT =
  'PASS_VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_FAIL_VERDICT =
  'FAIL_VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_STATUS =
  'VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_COMPLETE' as const;

export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_DIR =
  'datasets/stage7/vertical_ai_opportunity_identification_v17' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_DIR}/vertical-ai-opportunity-identification-v17.json` as const;
export const VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V17_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_DIR}/vertical-ai-project-truth-resolution-v17.json` as const;
export const VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V17_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_DIR}/vertical-ai-brain-assist-evidence-v17.json` as const;
export const VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V17_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_DIR}/vertical-ai-domain-opportunity-scores-v17.json` as const;
export const VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V17_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_DIR}/vertical-ai-selected-domain-opportunity-v17.json` as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_REPORT_PATH =
  'reports/stage7/VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_REPORT.json' as const;

export const VAOI17_CONTRACT_IDS = [
  'VAOI17_V16_PREREQUISITE_RESOLVED',
  'VAOI17_REINVESTMENT_COMPLETION_INTEGRATED',
  'VAOI17_PROJECT_TRUTH_RESOLVED',
  'VAOI17_BRAIN_ASSIST_EVIDENCE_PRESENT',
  'VAOI17_DOMAIN_SCORES_COMPUTED',
  'VAOI17_DOMAIN_CERTIFICATIONS_INTEGRATED',
  'VAOI17_HIGHEST_VALUE_DOMAIN_SELECTED',
  'VAOI17_EVIDENCE_BASED_DECISION',
] as const;
...
const EXECUTION_FLAGS = {
  vertical_ai_opportunity_identification_v17: true as const,
...
function validateContracts(input: {
  v16PrerequisiteResolved: boolean;
  ...
  const results = [
    {
      contract_id: 'VAOI17_V16_PREREQUISITE_RESOLVED',
      verdict: input.v16PrerequisiteResolved ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI17_REINVESTMENT_COMPLETION_INTEGRATED',
      verdict: input.reinvestmentCompletionIntegrated ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI17_PROJECT_TRUTH_RESOLVED',
      verdict: input.projectTruthResolved ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI17_BRAIN_ASSIST_EVIDENCE_PRESENT',
      verdict: input.brainAssistEvidencePresent ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI17_DOMAIN_SCORES_COMPUTED',
      verdict: input.domainScoresComputed ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI17_DOMAIN_CERTIFICATIONS_INTEGRATED',
      verdict: input.domainCertificationsIntegrated ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI17_HIGHEST_VALUE_DOMAIN_SELECTED',
      verdict: input.highestValueDomainSelected ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI17_EVIDENCE_BASED_DECISION',
...
export function writeVerticalAiOpportunityIdentificationV17EngineReport(): {
  passed: boolean;
  verdict: string;
  reportPath: string;
  selectedDomainId: string | null;
  ...
  const v16PrerequisiteResolved = phaseReportPassed(
    root,
    VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V16_REPORT_PATH,
    VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V16_PASS_VERDICT
  );
  if (!v16PrerequisiteResolved) {
    issues.push({
      code: 'PREREQ',
      message: 'PASS_VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V16 required',
      severity: 'error',
    });
  }
  ...
  const precheckPassed =
    v16PrerequisiteResolved && ontologyExists && capabilityModelExists && goalModelExists && lpmExists;
  ...
  if (precheckPassed) {
    ...
    writeJson(root, VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V17_PATH, {
      vertical_ai_project_truth_resolution_v17_id: 'vertical_ai_project_truth_resolution_v17',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_PHASE,
      ...
      vertical_ai_opportunity_identification_v16_prerequisite: v16PrerequisiteResolved,
      vertical_ai_opportunity_identification_v16_report_ref:
        VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V16_REPORT_PATH,
    });

    writeJson(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V17_PATH, {
      vertical_ai_brain_assist_evidence_v17_id: 'vertical_ai_brain_assist_evidence_v17',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    writeJson(root, VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V17_PATH, {
      vertical_ai_domain_opportunity_scores_v17_id: 'vertical_ai_domain_opportunity_scores_v17',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    writeJson(root, VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V17_PATH, {
      vertical_ai_selected_domain_opportunity_v17_id: 'vertical_ai_selected_domain_opportunity_v17',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    contractValidation = validateContracts({
      v16PrerequisiteResolved,
      reinvestmentCompletionIntegrated,
      projectTruthResolved: goalTruth.evaluated_goals > 0,
      brainAssistEvidencePresent: pathExists(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V17_PATH),
    ...
    if (contractValidation.aggregate_verdict !== 'PASS') {
      issues.push({
        ...
        message: 'One or more VAOI17 contracts failed',
        severity: 'error',
      });
    }
  }
  ...
  const verdict = passed
    ...
    : VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_FAIL_VERDICT;

  writeJson(root, VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_PATH, {
    vertical_ai_opportunity_identification_v17_id: 'vertical_ai_opportunity_identification_v17',
    architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
    phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_PHASE,
    generated_at: generatedAt,
    mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    decision_fingerprint: decisionFingerprint,
    selected_domain_id: selectedDomain?.domain_id ?? null,
    project_truth_ref: VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V17_PATH,
    brain_assist_evidence_ref: VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V17_PATH,
    domain_scores_ref: VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V17_PATH,
    selected_domain_ref: VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V17_PATH,
    lpm_mutation: false,
    brain_modification: false,
  });

  const report = {
    report_id: `vertical_ai_opportunity_identification_v17_${Date.now()}`,
    phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_PHASE,
    generated_at: generatedAt,
    mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    cycle_context: 'IMPLEMENTATION_CYCLE',
    goal: 'Select the highest-value eligible Vertical AI reinvestment domain.',
    vertical_ai_opportunity_identification_v17_passed: passed,
    final_verdict: verdict,
    status: passed
      ? VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_STATUS
      : 'VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_FAILED',
    decision_fingerprint: decisionFingerprint,
    ...
    domain_scores_ref: VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V17_PATH,
    selected_domain_ref: VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V17_PATH,
    identification_ref: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_PATH,
    domain_certifications: domainCertifications,
    reinvestment_completions: reinvestmentCompletions,
    ...
    checks: {
      ...
      V16_PREREQUISITE: v16PrerequisiteResolved,
      ...
      BRAIN_ASSIST_EVIDENCE_PRESENT: pathExists(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V17_PATH),
  ...
  writeJson(root, VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_REPORT_PATH, report);

  return {
    passed,
    verdict,
    reportPath: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V17_REPORT_PATH,
    selectedDomainId: selectedDomain?.domain_id ?? null,
  };
}
