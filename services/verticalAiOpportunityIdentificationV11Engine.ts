...
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_PHASE =
  'PHASE-VERTICAL-AI-OPPORTUNITY-IDENTIFICATION-V11' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_PASS_VERDICT =
  'PASS_VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_FAIL_VERDICT =
  'FAIL_VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_STATUS =
  'VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_COMPLETE' as const;

export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_DIR =
  'datasets/stage7/vertical_ai_opportunity_identification_v11' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_DIR}/vertical-ai-opportunity-identification-v11.json` as const;
export const VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V11_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_DIR}/vertical-ai-project-truth-resolution-v11.json` as const;
export const VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V11_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_DIR}/vertical-ai-brain-assist-evidence-v11.json` as const;
export const VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V11_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_DIR}/vertical-ai-domain-opportunity-scores-v11.json` as const;
export const VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V11_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_DIR}/vertical-ai-selected-domain-opportunity-v11.json` as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_REPORT_PATH =
  'reports/stage7/VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_REPORT.json' as const;

export const VAOI11_CONTRACT_IDS = [
  'VAOI11_PROJECT_TRUTH_RESOLVED',
  'VAOI11_BRAIN_ASSIST_EVIDENCE_PRESENT',
  'VAOI11_DOMAIN_SCORES_COMPUTED',
  'VAOI11_DOMAIN_CERTIFICATIONS_INTEGRATED',
  'VAOI11_HIGHEST_VALUE_DOMAIN_SELECTED',
  'VAOI11_EVIDENCE_BASED_DECISION',
] as const;
...
const EXECUTION_FLAGS = {
  vertical_ai_opportunity_identification_v11: true as const,
...
function validateContracts(input: {
  ...
  const results = [
    {
      contract_id: 'VAOI11_PROJECT_TRUTH_RESOLVED',
      verdict: input.projectTruthResolved ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI11_BRAIN_ASSIST_EVIDENCE_PRESENT',
      verdict: input.brainAssistEvidencePresent ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI11_DOMAIN_SCORES_COMPUTED',
      verdict: input.domainScoresComputed ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI11_DOMAIN_CERTIFICATIONS_INTEGRATED',
      verdict: input.domainCertificationsIntegrated ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI11_HIGHEST_VALUE_DOMAIN_SELECTED',
      verdict: input.highestValueDomainSelected ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI11_EVIDENCE_BASED_DECISION',
...
export function writeVerticalAiOpportunityIdentificationV11EngineReport(): {
  passed: boolean;
  verdict: string;
  reportPath: string;
  selectedDomainId: string | null;
  ...
  if (precheckPassed) {
    ...
    writeJson(root, VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V11_PATH, {
      vertical_ai_project_truth_resolution_v11_id: 'vertical_ai_project_truth_resolution_v11',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_PHASE,
    ...
    writeJson(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V11_PATH, {
      vertical_ai_brain_assist_evidence_v11_id: 'vertical_ai_brain_assist_evidence_v11',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    const quaternaryEligibleDomains = allDomainsCertified ? domainScores : [];
      ...
      primaryEligibleDomains.length > 0
        ...
        : fallbackEligibleDomains.length > 0
          ...
          : tertiaryEligibleDomains.length > 0
            ...
            : allDomainsCertified
              ? 'highest_value_score_among_all_domain_certified_domains'
              : 'none';
    selectedDomain =
    ...
    writeJson(root, VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V11_PATH, {
      vertical_ai_domain_opportunity_scores_v11_id: 'vertical_ai_domain_opportunity_scores_v11',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    writeJson(root, VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V11_PATH, {
      vertical_ai_selected_domain_opportunity_v11_id: 'vertical_ai_selected_domain_opportunity_v11',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
      ...
      rationale: selectedDomain
        ? `${selectedDomain.domain_id} is the highest-value Vertical AI domain by goal alignment (${selectedDomain.goal_alignment_score}), entity scale (${selectedDomain.entity_scale_score}), and dependency readiness (${selectedDomain.dependency_readiness_score})${primaryEligibleDomains.length === 0 ? (allDomainsCertified ? ' (all domains certified; highest-value reinvestment target)' : fallbackEligibleDomains.length === 0 ? (tertiaryEligibleDomains.length === 0 ? '' : ' (registry-incomplete fallback)') : ' (developed-uncertified fallback)') : ''}.`
    ...
    contractValidation = validateContracts({
      ...
      brainAssistEvidencePresent: pathExists(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V11_PATH),
    ...
    if (contractValidation.aggregate_verdict !== 'PASS') {
      issues.push({
        ...
        message: 'One or more VAOI11 contracts failed',
        severity: 'error',
      });
    }
  }
  ...
  const verdict = passed
    ...
    : VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_FAIL_VERDICT;

  writeJson(root, VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_PATH, {
    vertical_ai_opportunity_identification_v11_id: 'vertical_ai_opportunity_identification_v11',
    architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
    phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_PHASE,
    generated_at: generatedAt,
    mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    decision_fingerprint: decisionFingerprint,
    selected_domain_id: selectedDomain?.domain_id ?? null,
    project_truth_ref: VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V11_PATH,
    brain_assist_evidence_ref: VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V11_PATH,
    domain_scores_ref: VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V11_PATH,
    selected_domain_ref: VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V11_PATH,
    lpm_mutation: false,
    brain_modification: false,
  });

  const report = {
    report_id: `vertical_ai_opportunity_identification_v11_${Date.now()}`,
    phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_PHASE,
    generated_at: generatedAt,
    mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    cycle_context: 'IMPLEMENTATION_CYCLE',
    goal: 'Select the highest-value eligible Vertical AI domain.',
    vertical_ai_opportunity_identification_v11_passed: passed,
    final_verdict: verdict,
    status: passed
      ? VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_STATUS
      : 'VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_FAILED',
    decision_fingerprint: decisionFingerprint,
    ...
    eligible_domain_count: (() => {
      ...
      return domainScores.every((score) => score.domain_certified) ? domainScores.length : 0;
    })(),
    domain_certified_count: domainScores.filter((score) => score.domain_certified).length,
    project_truth_ref: VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V11_PATH,
    brain_assist_evidence_ref: VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V11_PATH,
    domain_scores_ref: VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V11_PATH,
    selected_domain_ref: VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V11_PATH,
    identification_ref: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_PATH,
    domain_certifications: domainCertifications,
    ...
    checks: {
      ...
      BRAIN_ASSIST_EVIDENCE_PRESENT: pathExists(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V11_PATH),
  ...
  writeJson(root, VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_REPORT_PATH, report);

  return {
    passed,
    verdict,
    reportPath: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V11_REPORT_PATH,
    selectedDomainId: selectedDomain?.domain_id ?? null,
  };
}
