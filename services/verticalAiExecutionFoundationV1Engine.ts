...
import {
  ...
  VERTICAL_AI_PLANNING_BOUNDARY_MODEL_V1_PATH,
  ...
  VERTICAL_AI_PLANNING_CONTRACTS_V1_PATH,
  VERTICAL_AI_PLANNING_REGISTRY_V1_PATH,
...
export const VERTICAL_AI_EXECUTION_FOUNDATION_V1_PHASE = 'PHASE-VAI-005' as const;
export const VERTICAL_AI_EXECUTION_FOUNDATION_V1_SYSTEM_ID = 'VERTICAL_AI_EXECUTION_FOUNDATION_V1' as const;
export const VERTICAL_AI_EXECUTION_FOUNDATION_V1_PASS_VERDICT =
  'PASS_VERTICAL_AI_EXECUTION_FOUNDATION_V1' as const;
export const VERTICAL_AI_EXECUTION_FOUNDATION_V1_FAIL_VERDICT =
  'FAIL_VERTICAL_AI_EXECUTION_FOUNDATION_V1' as const;
export const VERTICAL_AI_EXECUTION_FOUNDATION_V1_STATUS = 'VERTICAL_AI_EXECUTION_DEFINED' as const;

export const VERTICAL_AI_EXECUTION_FOUNDATION_V1_DIR = 'datasets/vertical_ai_execution_foundation_v1' as const;
export const VERTICAL_AI_EXECUTION_FOUNDATION_V1_PATH =
  `${VERTICAL_AI_EXECUTION_FOUNDATION_V1_DIR}/vertical-ai-execution-foundation-v1.json` as const;
export const VERTICAL_AI_EXECUTION_ARCHITECTURE_V1_PATH =
  `${VERTICAL_AI_EXECUTION_FOUNDATION_V1_DIR}/execution-architecture-v1.json` as const;
export const VERTICAL_AI_EXECUTION_COMPONENT_MODEL_V1_PATH =
  `${VERTICAL_AI_EXECUTION_FOUNDATION_V1_DIR}/execution-component-model-v1.json` as const;
export const VERTICAL_AI_EXECUTION_WORKFLOW_V1_PATH =
  `${VERTICAL_AI_EXECUTION_FOUNDATION_V1_DIR}/execution-workflow-v1.json` as const;
export const VERTICAL_AI_EXECUTION_BOUNDARY_MODEL_V1_PATH =
  `${VERTICAL_AI_EXECUTION_FOUNDATION_V1_DIR}/execution-boundary-model-v1.json` as const;
export const VERTICAL_AI_EXECUTION_CONTRACTS_V1_PATH =
  `${VERTICAL_AI_EXECUTION_FOUNDATION_V1_DIR}/execution-contracts-v1.json` as const;
export const VERTICAL_AI_EXECUTION_REGISTRY_V1_PATH =
  `${VERTICAL_AI_EXECUTION_FOUNDATION_V1_DIR}/execution-registry-v1.json` as const;
export const VERTICAL_AI_EXECUTION_APPROVAL_GATE_V1_PATH =
  `${VERTICAL_AI_EXECUTION_FOUNDATION_V1_DIR}/execution-approval-gate-v1.json` as const;
export const VERTICAL_AI_EXECUTION_EVIDENCE_MODEL_V1_PATH =
  `${VERTICAL_AI_EXECUTION_FOUNDATION_V1_DIR}/execution-evidence-model-v1.json` as const;
export const VERTICAL_AI_EXECUTION_TRACEABILITY_V1_PATH =
  `${VERTICAL_AI_EXECUTION_FOUNDATION_V1_DIR}/execution-traceability-v1.json` as const;
export const VERTICAL_AI_EXECUTION_CONNECTOR_SELECTION_V1_PATH =
  `${VERTICAL_AI_EXECUTION_FOUNDATION_V1_DIR}/execution-connector-selection-v1.json` as const;
export const VERTICAL_AI_EXECUTION_RUNTIME_REF_V1_PATH =
  `${VERTICAL_AI_EXECUTION_FOUNDATION_V1_DIR}/execution-runtime-ref-v1.json` as const;
export const VERTICAL_AI_EXECUTION_FOUNDATION_V1_REPORT_PATH =
  'reports/vertical_ai/VERTICAL_AI_EXECUTION_FOUNDATION_V1_REPORT.json' as const;

const FOUNDATION_NAME = 'Evidence-Bound Vertical AI Execution Foundation V1' as const;
const CAPABILITY_ID = 'vertical_ai_execution' as const;
const LAYER_ID = 'execution' as const;

export const VAIEF_CONTRACT_IDS = [
  'VAIEF_PLANNING_RUNTIME_VERIFIED',
  'VAIEF_CIL_COMPLETE_VERIFIED',
  'VAIEF_PLATFORM_CORE_READY',
  'VAIEF_REPOSITORY_INTELLIGENCE_READY',
  'VAIEF_CERTIFIED_CONNECTORS_BOUND',
  'VAIEF_COMPONENTS_DEFINED',
  'VAIEF_CONNECTOR_SELECTION_STANDARDIZED',
  'VAIEF_EVIDENCE_TO_EXECUTION_TRACEABILITY',
  'VAIEF_EXECUTION_REPRODUCIBILITY',
  'VAIEF_REPOSITORY_FIRST',
  'VAIEF_EVIDENCE_FIRST',
  'VAIEF_REUSE_BEFORE_CREATE',
  'VAIEF_HUMAN_APPROVAL_BEFORE_REPO_MUTATION',
  'VAIEF_CONSUMES_PLATFORM_CORE_V1_ONLY',
  'VAIEF_CONSUMES_CIL_V1_ONLY',
  'VAIEF_CONSUMES_REPOSITORY_INTELLIGENCE_ONLY',
  'VAIEF_CONSUMES_CERTIFIED_CONNECTORS_ONLY',
  'VAIEF_DESIGN_ONLY',
  'VAIEF_READ_ONLY',
  'VAIEF_REFERENCE_ONLY',
  'VAIEF_NO_SOURCE_DATA_OWNERSHIP',
  'VAIEF_NO_PLATFORM_CORE_MUTATION',
  'VAIEF_NO_CIL_MUTATION',
  'VAIEF_READY_FOR_EXECUTION_RUNTIME',
  'VAIEF_FOUNDATION_READY',
] as const;
...
/**
 * Vertical AI Execution is design-only capacity that turns validated planning outputs into
 * evidence-traced execution descriptors. Execution selects certified consumer connectors and
 * Agent Runtime tools; it never mutates Platform Core or CIL. Repository mutation requires
 * human approval. Reuse precedes create; evidence precedes execution conclusions.
 */
const EXECUTION_COMPONENTS = [
  {
    component_id: 'execution_context',
    name: 'Execution Context',
    responsibility:
      'Assemble a read-only execution context from planning runtime outputs, Platform Core, CIL, Repository Intelligence, and certified connector snapshots.',
  ...
  {
    component_id: 'execution_selector',
    name: 'Execution Selector',
    responsibility:
      'Select executable steps from validated execution plans using repository-first and reuse-before-create priority; never invents unauthorized writes.',
  ...
  {
    component_id: 'execution_dispatch',
    name: 'Execution Dispatch',
    responsibility:
      'Describe how selected steps would be dispatched to Agent Runtime through CIL runtime connectors; dispatch descriptors are design-only and not enacted in foundation.',
    interface_kind: 'dispatch',
    owns_source_data: false,
    mode: 'orchestration_descriptor',
    write_authorized: false,
  },
  {
    component_id: 'tool_selection',
    name: 'Tool Selection',
    responsibility:
      'Select Agent Runtime tools that may serve selected steps, using certified runtime contracts only; tools are references, never redefined here.',
    interface_kind: 'selection',
    owns_source_data: false,
    mode: 'reference_only',
    write_authorized: false,
  ...
  {
    component_id: 'consumer_connector_selection',
    name: 'Consumer Connector Selection',
    responsibility:
      'Standardize selection among certified consumer connectors (Claude, ChatGPT, Gemini, Cursor, MCP) for reasoning-side participation; selection is reference-bound to master snapshots.',
    interface_kind: 'selection',
    owns_source_data: false,
    mode: 'certified_connectors_only',
    write_authorized: false,
  },
  {
    component_id: 'execution_contract',
    name: 'Execution Contract',
    responsibility:
      'Declare the execution boundary contract: consumes Platform Core V1 / CIL V1 / RI / certified connectors only; forbids PC/CIL mutation and unapproved repository mutation.',
  ...
  {
    component_id: 'execution_validation',
    name: 'Execution Validation',
    responsibility:
      'Validate execution descriptors for evidence citations, connector certification, reuse precedence, and approval readiness before runtime handoff.',
  ...
  {
    component_id: 'execution_evidence',
    name: 'Execution Evidence',
    responsibility:
      'Bind fingerprints and refs so every execution conclusion is preceded by planning and understanding evidence.',
  ...
  {
    component_id: 'execution_traceability',
    name: 'Execution Traceability',
    responsibility:
      'Maintain evidence-to-execution traceability from planning outputs through selector, tools, connectors, dispatch, and validation.',
    interface_kind: 'traceability',
    owns_source_data: false,
    mode: 'evidence_to_execution',
    write_authorized: false,
  },
  {
    component_id: 'execution_reproducibility',
    name: 'Execution Reproducibility',
    responsibility:
      'Ensure identical evidence and plan inputs yield identical execution design fingerprints across dual runs.',
  ...
  {
    component_id: 'execution_runtime_ref',
    name: 'Execution Runtime Reference',
    responsibility:
      'Reference the certified Agent Runtime and CIL runtime connector surfaces that future Execution Runtime will bind; reference-only, no mutation.',
  ...
  },
  {
    ...
    name: 'Approval Gate',
    responsibility:
      'Require explicit human approval before any repository mutation that execution might later propose; foundation runs remain read-only.',
    interface_kind: 'gate',
    owns_source_data: false,
  ...
  },
  {
    ...
    responsibility:
      'Codify immutable boundaries: no Platform Core mutation, no CIL mutation, certified-connector-only selection, repository mutation gated by human approval.',
...
const FOUNDATION_PRINCIPLES = {
  ...
  evidence_to_execution_traceability: true,
  execution_reproducibility: true,
  connector_selection_standardized: true,
  ...
  consumes_planning_runtime: true,
  owns_source_data: false,
  platform_core_mutation: false,
  cil_mutation: false,
  execution_runtime_deferred: true,
...
const EVIDENCE_TO_EXECUTION_WORKFLOW = {
  workflow_id: 'evidence_to_execution_v1',
  policy: 'evidence_first_execution',
  reuse_policy: 'reuse_before_create',
  repository_policy: 'repository_first',
  connector_policy: 'certified_connectors_only',
  evidence_policy: 'evidence_precedes_execution_conclusions',
  write_policy: 'human_approval_required_before_repository_mutation',
  traceability_policy: 'evidence_to_execution',
  steps: [
    { step_id: 'build_context', component_id: 'execution_context', write: false },
    { step_id: 'bind_runtime_ref', component_id: 'execution_runtime_ref', write: false },
    { step_id: 'select_execution', component_id: 'execution_selector', write: false },
    { step_id: 'select_tools', component_id: 'tool_selection', write: false },
    { step_id: 'select_connectors', component_id: 'consumer_connector_selection', write: false },
    { step_id: 'declare_contract', component_id: 'execution_contract', write: false },
    { step_id: 'describe_dispatch', component_id: 'execution_dispatch', write: false },
    { step_id: 'validate', component_id: 'execution_validation', write: false },
    { step_id: 'bind_evidence', component_id: 'execution_evidence', write: false },
    { step_id: 'trace', component_id: 'execution_traceability', write: false },
    { step_id: 'reproducibility', component_id: 'execution_reproducibility', write: false },
    { step_id: 'bound', component_id: 'execution_boundary', write: false },
    {
      step_id: 'approval',
      component_id: 'approval_gate',
      write: false,
    ...
    {
      step_id: 'execution_runtime_handoff',
      deferred: true,
      requires: ['execution_foundation_ready', 'human_approval_if_repository_mutation'],
    },
  ],
  forbidden_before_evidence: [
    'dispatch_without_validation',
...
const PROPOSED_VAI_PHASE_CHAIN = [
  { phase_id: 'PHASE-VAI-003', title: 'Planning foundation', focus: 'Evidence-first planning design' },
  { phase_id: 'PHASE-VAI-004', title: 'Planning runtime', focus: 'Operational planning runtime' },
  {
    phase_id: 'PHASE-VAI-005',
    title: 'Execution foundation',
    focus: 'Design evidence-to-execution with standardized connector selection',
  },
  {
    phase_id: 'PHASE-VAI-006',
    title: 'Execution runtime',
    focus: 'Implement execution runtime over certified foundation',
  },
] as const;
...
const PROTECTED_PLANNING_PATHS = [
  VERTICAL_AI_PLANNING_FOUNDATION_V1_PATH,
  VERTICAL_AI_PLANNING_ARCHITECTURE_V1_PATH,
  VERTICAL_AI_PLANNING_COMPONENT_MODEL_V1_PATH,
  VERTICAL_AI_PLANNING_WORKFLOW_V1_PATH,
...
const PRECONDITION_EVIDENCE = [
  {
    precondition_id: 'planning_runtime',
...
function validateFoundationContracts(input: Record<string, boolean>) {
  const map: Array<[string, string]> = [
    ['VAIEF_PLANNING_RUNTIME_VERIFIED', 'planningRuntimeVerified'],
    ['VAIEF_CIL_COMPLETE_VERIFIED', 'cilCompleteVerified'],
    ['VAIEF_PLATFORM_CORE_READY', 'platformCoreReady'],
    ['VAIEF_REPOSITORY_INTELLIGENCE_READY', 'repositoryIntelligenceReady'],
    ['VAIEF_CERTIFIED_CONNECTORS_BOUND', 'certifiedConnectorsBound'],
    ['VAIEF_COMPONENTS_DEFINED', 'componentsDefined'],
    ['VAIEF_CONNECTOR_SELECTION_STANDARDIZED', 'connectorSelectionStandardized'],
    ['VAIEF_EVIDENCE_TO_EXECUTION_TRACEABILITY', 'evidenceToExecutionTraceability'],
    ['VAIEF_EXECUTION_REPRODUCIBILITY', 'executionReproducibility'],
    ['VAIEF_REPOSITORY_FIRST', 'repositoryFirst'],
    ['VAIEF_EVIDENCE_FIRST', 'evidenceFirst'],
    ['VAIEF_REUSE_BEFORE_CREATE', 'reuseBeforeCreate'],
    ['VAIEF_HUMAN_APPROVAL_BEFORE_REPO_MUTATION', 'humanApprovalBeforeRepoMutation'],
    ['VAIEF_CONSUMES_PLATFORM_CORE_V1_ONLY', 'consumesPlatformCoreV1Only'],
    ['VAIEF_CONSUMES_CIL_V1_ONLY', 'consumesCilV1Only'],
    ['VAIEF_CONSUMES_REPOSITORY_INTELLIGENCE_ONLY', 'consumesRepositoryIntelligenceOnly'],
    ['VAIEF_CONSUMES_CERTIFIED_CONNECTORS_ONLY', 'consumesCertifiedConnectorsOnly'],
    ['VAIEF_DESIGN_ONLY', 'designOnly'],
    ['VAIEF_READ_ONLY', 'readOnly'],
    ['VAIEF_REFERENCE_ONLY', 'referenceOnly'],
    ['VAIEF_NO_SOURCE_DATA_OWNERSHIP', 'noSourceDataOwnership'],
    ['VAIEF_NO_PLATFORM_CORE_MUTATION', 'noPlatformCoreMutation'],
    ['VAIEF_NO_CIL_MUTATION', 'noCilMutation'],
    ['VAIEF_READY_FOR_EXECUTION_RUNTIME', 'readyForExecutionRuntime'],
    ['VAIEF_FOUNDATION_READY', 'foundationReady'],
  ];
  ...
  return {
    contract_ids: [...VAIEF_CONTRACT_IDS],
    results,
    aggregate_verdict: pass ? ('PASS' as const) : ('FAIL' as const),
  };
}

export function writeVerticalAiExecutionFoundationV1EngineReport(): {
  passed: boolean;
  verdict: string;
  reportPath: string;
} {
  ...
  const planningBaselineBefore = captureBaselineMtimes(root, PROTECTED_PLANNING_PATHS);
  ...
  const planningRuntimeVerified =
    preconditionResults.find((entry) => entry.precondition_id === 'planning_runtime')?.satisfied ===
    true;
  ...
  const planningRuntime = readJson<{
    decision_fingerprint?: string;
    runtime_implemented?: boolean;
    ready_for_execution_planning?: boolean;
    result_fingerprint?: string;
    plan_fingerprint?: string;
  }>(root, VERTICAL_AI_PLANNING_RUNTIME_V1_PATH);
  ...
  if (planningRuntime?.runtime_implemented !== true) {
    issues.push({
      code: 'PLANNING_RUNTIME_NOT_IMPLEMENTED',
      message: 'Planning Runtime must be implemented',
      severity: 'error',
    });
  }
  ...
  const connectorSelectionModel = {
    selection_policy: 'certified_connectors_only',
    standardized: true,
    connectors: CERTIFIED_CONNECTORS.map((connector) => ({
      connector_id: connector.connector_id,
      master_snapshot_ref: connector.master_snapshot_ref,
      present: pathExists(root, connector.master_snapshot_ref),
      selectable: true,
      uncertified_forbidden: true,
    })),
    selection_order: CERTIFIED_CONNECTORS.map((connector) => connector.connector_id),
    binds_to_cil: {
      connector_contract_ref: CONSUMER_CONNECTOR_CONTRACT_V1_PATH,
      connector_registry_ref: CONNECTOR_CONTRACT_REGISTRY_V1_PATH,
  ...
  const consumedRefs = {
    ...
    planning: {
      ...
      runtime_ref: VERTICAL_AI_PLANNING_RUNTIME_V1_PATH,
      result_fingerprint: planningRuntime?.result_fingerprint ?? null,
      plan_fingerprint: planningRuntime?.plan_fingerprint ?? null,
    },
  ...
  const designFingerprint = stableFingerprint({
    ...
    workflow: EVIDENCE_TO_EXECUTION_WORKFLOW,
    connector_selection: connectorSelectionModel,
  ...
  const decisionFingerprint = stableFingerprint({
    ...
    planningDecision: planningRuntime?.decision_fingerprint ?? null,
  ...
  const executionReproducibilityFingerprint = stableFingerprint({
    designFingerprint,
    planningResult: planningRuntime?.result_fingerprint ?? null,
    planningPlan: planningRuntime?.plan_fingerprint ?? null,
    connectors: connectorSelectionModel.selection_order,
    evidenceFirst: true,
  });

  writeJson(root, VERTICAL_AI_EXECUTION_COMPONENT_MODEL_V1_PATH, {
    execution_component_model_v1_id: 'execution_component_model_v1',
    architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
    phase: VERTICAL_AI_EXECUTION_FOUNDATION_V1_PHASE,
    ...
    layer_id: LAYER_ID,
    responsibility:
      'Design evidence-to-execution Vertical AI capacity with standardized certified connector selection and gated repository mutation',
    components: EXECUTION_COMPONENTS,
    principles: FOUNDATION_PRINCIPLES,
    design_only: true,
    implementation: false,
  ...
  writeJson(root, VERTICAL_AI_EXECUTION_CONNECTOR_SELECTION_V1_PATH, {
    execution_connector_selection_v1_id: 'execution_connector_selection_v1',
    architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
    phase: VERTICAL_AI_EXECUTION_FOUNDATION_V1_PHASE,
    generated_at: generatedAt,
    mode: 'READ_ONLY',
    ...connectorSelectionModel,
    connector_selection_standardized: true,
  });

  writeJson(root, VERTICAL_AI_EXECUTION_RUNTIME_REF_V1_PATH, {
    execution_runtime_ref_v1_id: 'execution_runtime_ref_v1',
    architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
    phase: VERTICAL_AI_EXECUTION_FOUNDATION_V1_PHASE,
    generated_at: generatedAt,
    mode: 'READ_ONLY',
    ...
    agent_runtime_production_certification_ref: AGENT_RUNTIME_PRODUCTION_CERTIFICATION_V1_PATH,
    cil_runtime_connector_ref: RUNTIME_CONNECTOR_V1_PATH,
    planning_runtime_ref: VERTICAL_AI_PLANNING_RUNTIME_V1_PATH,
    reference_only: true,
    mutation_forbidden: true,
  });

  writeJson(root, VERTICAL_AI_EXECUTION_WORKFLOW_V1_PATH, {
    execution_workflow_v1_id: 'execution_workflow_v1',
    architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
    phase: VERTICAL_AI_EXECUTION_FOUNDATION_V1_PHASE,
    generated_at: generatedAt,
    mode: 'READ_ONLY',
    ...
    execution_runtime_deferred: true,
    workflow: EVIDENCE_TO_EXECUTION_WORKFLOW,
    readiness_for_execution_runtime: {
      requires: [
        'execution_components_defined',
        'connector_selection_standardized',
        'evidence_to_execution_traceability',
        'approval_gate_armed',
      ],
  ...
  writeJson(root, VERTICAL_AI_EXECUTION_APPROVAL_GATE_V1_PATH, {
    execution_approval_gate_v1_id: 'execution_approval_gate_v1',
    architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
    phase: VERTICAL_AI_EXECUTION_FOUNDATION_V1_PHASE,
    generated_at: generatedAt,
    mode: 'READ_ONLY',
    gate_policy: {
      human_approval_required_before_repository_mutation: true,
      execution_foundation_runs_are_read_only: true,
      repository_mutation_blocked_until_approval: true,
      platform_core_mutation_forbidden: true,
      cil_mutation_forbidden: true,
      execution_runtime_handoff_requires_foundation: true,
    },
    write_actions_gated: [
      'repository_create',
      'repository_modify',
      'repository_delete',
      'execution_runtime_materialization',
      'dispatch_enactment',
    ],
    design_only: true,
    write_authorized: false,
  ...
  writeJson(root, VERTICAL_AI_EXECUTION_EVIDENCE_MODEL_V1_PATH, {
    execution_evidence_model_v1_id: 'execution_evidence_model_v1',
    architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
    phase: VERTICAL_AI_EXECUTION_FOUNDATION_V1_PHASE,
    generated_at: generatedAt,
    mode: 'READ_ONLY',
    evidence_policy: {
      evidence_first: true,
      evidence_precedes_execution_conclusions: true,
      conclusions_without_evidence_forbidden: true,
      fingerprints_required: true,
      planning_runtime_citations_required: true,
  ...
  writeJson(root, VERTICAL_AI_EXECUTION_TRACEABILITY_V1_PATH, {
    execution_traceability_v1_id: 'execution_traceability_v1',
    architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
    phase: VERTICAL_AI_EXECUTION_FOUNDATION_V1_PHASE,
    generated_at: generatedAt,
    mode: 'READ_ONLY',
    evidence_to_execution_traceability: true,
    chain: [
      { from: 'planning_runtime', to: 'execution_context' },
      { from: 'execution_context', to: 'execution_selector' },
      { from: 'execution_runtime_ref', to: 'tool_selection' },
      { from: 'execution_selector', to: 'tool_selection' },
      { from: 'execution_selector', to: 'consumer_connector_selection' },
      { from: 'tool_selection', to: 'execution_dispatch' },
      { from: 'consumer_connector_selection', to: 'execution_dispatch' },
      { from: 'execution_contract', to: 'execution_validation' },
      { from: 'execution_dispatch', to: 'execution_validation' },
      { from: 'execution_evidence', to: 'execution_traceability' },
      { from: 'execution_traceability', to: 'execution_reproducibility' },
      { from: 'execution_boundary', to: 'approval_gate' },
    ],
    reproducibility_fingerprint: executionReproducibilityFingerprint,
  });

  writeJson(root, VERTICAL_AI_EXECUTION_BOUNDARY_MODEL_V1_PATH, {
    execution_boundary_model_v1_id: 'execution_boundary_model_v1',
    architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
    phase: VERTICAL_AI_EXECUTION_FOUNDATION_V1_PHASE,
    generated_at: generatedAt,
    mode: 'READ_ONLY',
  ...
  writeJson(root, VERTICAL_AI_EXECUTION_ARCHITECTURE_V1_PATH, {
    execution_architecture_v1_id: 'execution_architecture_v1',
    architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
    phase: VERTICAL_AI_EXECUTION_FOUNDATION_V1_PHASE,
    generated_at: generatedAt,
    mode: 'READ_ONLY',
    ...
    capability_id: CAPABILITY_ID,
    layer_id: LAYER_ID,
    selected_architecture: 'Evidence-to-Execution Vertical AI Foundation with Standardized Connector Selection',
    independence_statement:
      'Vertical AI Execution turns validated planning into evidence-traced execution descriptors. It consumes Platform Core V1, CIL V1, Repository Intelligence, certified Consumer Connectors, and Planning Runtime only — read-only and reference-only — and never mutates Platform Core or CIL. Connector selection is standardized to certified masters. Human approval is required before repository mutation. Evolution of this capability is independent of Platform Core and CIL.',
    stack: {
      platform_core: { role: 'Semantic + structural + execution truth', interaction: 'consume_v1_only' },
      cil: { role: 'Certified integration + runtime connector contracts', interaction: 'consume_v1_only' },
      repository_intelligence: { role: 'Structural repository truth', interaction: 'reference_only' },
      certified_connectors: {
        role: 'Reasoning-side certified consumers',
        interaction: 'standardized_selection',
      },
      planning_runtime: { role: 'Validated plans and evidence', interaction: 'consume_operational_plans' },
      execution: {
        role: 'Evidence-to-execution design before execution runtime',
        interaction: 'design_only_foundation',
        owns_source_data: false,
      },
    },
    component_model_ref: VERTICAL_AI_EXECUTION_COMPONENT_MODEL_V1_PATH,
    workflow_ref: VERTICAL_AI_EXECUTION_WORKFLOW_V1_PATH,
    boundary_model_ref: VERTICAL_AI_EXECUTION_BOUNDARY_MODEL_V1_PATH,
    approval_gate_ref: VERTICAL_AI_EXECUTION_APPROVAL_GATE_V1_PATH,
    evidence_model_ref: VERTICAL_AI_EXECUTION_EVIDENCE_MODEL_V1_PATH,
    traceability_ref: VERTICAL_AI_EXECUTION_TRACEABILITY_V1_PATH,
    connector_selection_ref: VERTICAL_AI_EXECUTION_CONNECTOR_SELECTION_V1_PATH,
    execution_runtime_ref: VERTICAL_AI_EXECUTION_RUNTIME_REF_V1_PATH,
  ...
  const componentsDefined =
    EXECUTION_COMPONENTS.length === REQUIRED_COMPONENT_IDS.length &&
    REQUIRED_COMPONENT_IDS.every((id) =>
      EXECUTION_COMPONENTS.some((component) => component.component_id === id)
    );

  const connectorSelectionStandardized =
    FOUNDATION_PRINCIPLES.connector_selection_standardized === true &&
    connectorSelectionModel.standardized === true &&
    connectorSelectionModel.selection_policy === 'certified_connectors_only' &&
    EXECUTION_COMPONENTS.some((component) => component.component_id === 'consumer_connector_selection');

  const evidenceToExecutionTraceability =
    FOUNDATION_PRINCIPLES.evidence_to_execution_traceability === true &&
    EXECUTION_COMPONENTS.some((component) => component.component_id === 'execution_traceability');

  const executionReproducibility =
    FOUNDATION_PRINCIPLES.execution_reproducibility === true &&
    EXECUTION_COMPONENTS.some((component) => component.component_id === 'execution_reproducibility') &&
    executionReproducibilityFingerprint.length === 16;

  const repositoryFirst =
    FOUNDATION_PRINCIPLES.repository_first === true &&
    EVIDENCE_TO_EXECUTION_WORKFLOW.repository_policy === 'repository_first';
  const evidenceFirst =
    FOUNDATION_PRINCIPLES.evidence_first === true &&
    EVIDENCE_TO_EXECUTION_WORKFLOW.policy === 'evidence_first_execution';
  const reuseBeforeCreate =
    FOUNDATION_PRINCIPLES.reuse_precedes_creation === true &&
    EVIDENCE_TO_EXECUTION_WORKFLOW.reuse_policy === 'reuse_before_create';

  const humanApprovalBeforeRepoMutation =
    FOUNDATION_PRINCIPLES.human_approval_required_before_repository_mutation === true &&
    EXECUTION_COMPONENTS.some((component) => component.component_id === 'approval_gate') &&
    EXECUTION_COMPONENTS.every((component) => component.write_authorized === false);
  ...
  const noSourceDataOwnership =
    ...
    EXECUTION_COMPONENTS.every((component) => component.owns_source_data === false);
  ...
  const baselineChecks: Array<[string, { preserved: boolean; drift: string[] }, string]> = [
    ...
    ['PLANNING_BASELINE_MUTATION', planningBaselineAfter, 'Planning baseline changed'],
  ];
  ...
  const foundationReadyCandidate =
    ...
    allGoalsSatisfied &&
    componentsDefined &&
    planningRuntimeVerified &&
    cilCompleteVerified &&
    platformCoreReady &&
    repositoryIntelligenceReady &&
    certifiedConnectorsBound &&
    connectorSelectionStandardized &&
    evidenceToExecutionTraceability &&
  ...
  const readyForExecutionRuntime =
    foundationReadyCandidate &&
    FOUNDATION_PRINCIPLES.execution_runtime_deferred === true &&
    designOnly &&
    planningRuntime?.ready_for_execution_planning === true;

  const foundationReady = foundationReadyCandidate && readyForExecutionRuntime;
  ...
  if (contractValidation.aggregate_verdict !== 'PASS') {
    issues.push({
      ...
      message: 'One or more Vertical AI Execution foundation contracts failed',
      severity: 'error',
    });
  }

  writeJson(root, VERTICAL_AI_EXECUTION_CONTRACTS_V1_PATH, {
    execution_contracts_v1_id: 'execution_contracts_v1',
    architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
    phase: VERTICAL_AI_EXECUTION_FOUNDATION_V1_PHASE,
    generated_at: generatedAt,
  ...
  writeJson(root, VERTICAL_AI_EXECUTION_FOUNDATION_V1_PATH, {
    vertical_ai_execution_foundation_v1_id: 'vertical_ai_execution_foundation_v1',
    architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
    phase: VERTICAL_AI_EXECUTION_FOUNDATION_V1_PHASE,
    system_id: VERTICAL_AI_EXECUTION_FOUNDATION_V1_SYSTEM_ID,
    generated_at: generatedAt,
    mode: 'READ_ONLY',
    foundation_name: FOUNDATION_NAME,
    capability_id: CAPABILITY_ID,
    ...
    execution_reproducibility_fingerprint: executionReproducibilityFingerprint,
    ...
    ready_for_execution_runtime: readyForExecutionRuntime,
    execution_foundation_established: foundationReady,
    connector_selection_standardized: connectorSelectionStandardized,
    evidence_to_execution_traceability: evidenceToExecutionTraceability,
    execution_reproducible: executionReproducibility,
    ...
    architecture_ref: VERTICAL_AI_EXECUTION_ARCHITECTURE_V1_PATH,
    component_model_ref: VERTICAL_AI_EXECUTION_COMPONENT_MODEL_V1_PATH,
    workflow_ref: VERTICAL_AI_EXECUTION_WORKFLOW_V1_PATH,
    boundary_model_ref: VERTICAL_AI_EXECUTION_BOUNDARY_MODEL_V1_PATH,
    approval_gate_ref: VERTICAL_AI_EXECUTION_APPROVAL_GATE_V1_PATH,
    ...
    connector_selection_ref: VERTICAL_AI_EXECUTION_CONNECTOR_SELECTION_V1_PATH,
    execution_runtime_ref: VERTICAL_AI_EXECUTION_RUNTIME_REF_V1_PATH,
    contracts_ref: VERTICAL_AI_EXECUTION_CONTRACTS_V1_PATH,
    registry_ref: VERTICAL_AI_EXECUTION_REGISTRY_V1_PATH,
    components: EXECUTION_COMPONENTS.map((component) => component.component_id),
    principles: FOUNDATION_PRINCIPLES,
    platform_core_mutation: false,
    cil_mutation: false,
  ...
  writeJson(root, VERTICAL_AI_EXECUTION_REGISTRY_V1_PATH, {
    registry_id: 'execution-registry-v1',
    phase: VERTICAL_AI_EXECUTION_FOUNDATION_V1_PHASE,
    system_id: VERTICAL_AI_EXECUTION_FOUNDATION_V1_SYSTEM_ID,
    version: 'vertical_ai_execution_foundation_v1',
    generated_at: generatedAt,
    foundation_ref: VERTICAL_AI_EXECUTION_FOUNDATION_V1_PATH,
    architecture_ref: VERTICAL_AI_EXECUTION_ARCHITECTURE_V1_PATH,
    contracts_ref: VERTICAL_AI_EXECUTION_CONTRACTS_V1_PATH,
    ...
    connector_selection_ref: VERTICAL_AI_EXECUTION_CONNECTOR_SELECTION_V1_PATH,
    execution_runtime_ref: VERTICAL_AI_EXECUTION_RUNTIME_REF_V1_PATH,
    component_ids: EXECUTION_COMPONENTS.map((component) => component.component_id),
  ...
  const verdict = passed
    ...
    : VERTICAL_AI_EXECUTION_FOUNDATION_V1_FAIL_VERDICT;

  const report = {
    report_id: `vertical_ai_execution_foundation_v1_${Date.now()}`,
    phase: VERTICAL_AI_EXECUTION_FOUNDATION_V1_PHASE,
    system_id: VERTICAL_AI_EXECUTION_FOUNDATION_V1_SYSTEM_ID,
    generated_at: generatedAt,
    goal: 'Design the Vertical AI Execution Foundation as evidence-to-execution planning with standardized certified connector selection and human approval before repository mutation.',
    vertical_ai_execution_foundation_v1_passed: passed,
    final_verdict: verdict,
    status: passed
      ? VERTICAL_AI_EXECUTION_FOUNDATION_V1_STATUS
      : 'VERTICAL_AI_EXECUTION_FOUNDATION_NOT_READY',
    ...
    planning_baseline_preserved: planningBaselineAfter.preserved,
    ...
    execution_foundation_established: foundationReady,
    connector_selection_standardized: connectorSelectionStandardized,
    evidence_to_execution_traceability_established: evidenceToExecutionTraceability,
    execution_reproducible: executionReproducibility,
    ...
    checks: {
      PRECONDITIONS_SATISFIED: preconditionsSatisfied,
      PLANNING_RUNTIME_VERIFIED: planningRuntimeVerified,
      ...
      CONNECTOR_SELECTION_STANDARDIZED: connectorSelectionStandardized,
      EVIDENCE_TO_EXECUTION_TRACEABILITY: evidenceToExecutionTraceability,
      EXECUTION_REPRODUCIBILITY: executionReproducibility,
      REPOSITORY_FIRST: repositoryFirst,
      EVIDENCE_FIRST: evidenceFirst,
      REUSE_BEFORE_CREATE: reuseBeforeCreate,
  ...
  writeJson(root, VERTICAL_AI_EXECUTION_FOUNDATION_V1_REPORT_PATH, report);

  return {
    passed,
    verdict,
    reportPath: VERTICAL_AI_EXECUTION_FOUNDATION_V1_REPORT_PATH,
  };
}
