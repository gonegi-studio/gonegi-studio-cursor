...
import {
  VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V12_PASS_VERDICT,
  VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V12_REPORT_PATH,
} from './verticalAiOpportunityIdentificationV12Engine.js';
import {
...
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_PHASE =
  'PHASE-VERTICAL-AI-OPPORTUNITY-IDENTIFICATION-V13' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_PASS_VERDICT =
  'PASS_VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_FAIL_VERDICT =
  'FAIL_VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_STATUS =
  'VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_COMPLETE' as const;

export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_DIR =
  'datasets/stage7/vertical_ai_opportunity_identification_v13' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_DIR}/vertical-ai-opportunity-identification-v13.json` as const;
export const VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V13_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_DIR}/vertical-ai-project-truth-resolution-v13.json` as const;
export const VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V13_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_DIR}/vertical-ai-brain-assist-evidence-v13.json` as const;
export const VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V13_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_DIR}/vertical-ai-domain-opportunity-scores-v13.json` as const;
export const VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V13_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_DIR}/vertical-ai-selected-domain-opportunity-v13.json` as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_REPORT_PATH =
  'reports/stage7/VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_REPORT.json' as const;

export const VAOI13_CONTRACT_IDS = [
  'VAOI13_V12_PREREQUISITE_RESOLVED',
  'VAOI13_REINVESTMENT_COMPLETION_INTEGRATED',
  'VAOI13_PROJECT_TRUTH_RESOLVED',
  'VAOI13_BRAIN_ASSIST_EVIDENCE_PRESENT',
  'VAOI13_DOMAIN_SCORES_COMPUTED',
  'VAOI13_DOMAIN_CERTIFICATIONS_INTEGRATED',
  'VAOI13_HIGHEST_VALUE_DOMAIN_SELECTED',
  'VAOI13_EVIDENCE_BASED_DECISION',
] as const;
...
const EXECUTION_FLAGS = {
  vertical_ai_opportunity_identification_v13: true as const,
...
function validateContracts(input: {
  v12PrerequisiteResolved: boolean;
  ...
  const results = [
    {
      contract_id: 'VAOI13_V12_PREREQUISITE_RESOLVED',
      verdict: input.v12PrerequisiteResolved ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI13_REINVESTMENT_COMPLETION_INTEGRATED',
      verdict: input.reinvestmentCompletionIntegrated ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI13_PROJECT_TRUTH_RESOLVED',
      verdict: input.projectTruthResolved ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI13_BRAIN_ASSIST_EVIDENCE_PRESENT',
      verdict: input.brainAssistEvidencePresent ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI13_DOMAIN_SCORES_COMPUTED',
      verdict: input.domainScoresComputed ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI13_DOMAIN_CERTIFICATIONS_INTEGRATED',
      verdict: input.domainCertificationsIntegrated ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI13_HIGHEST_VALUE_DOMAIN_SELECTED',
      verdict: input.highestValueDomainSelected ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI13_EVIDENCE_BASED_DECISION',
...
export function writeVerticalAiOpportunityIdentificationV13EngineReport(): {
  passed: boolean;
  verdict: string;
  reportPath: string;
  selectedDomainId: string | null;
  ...
  const v12PrerequisiteResolved = phaseReportPassed(
    root,
    VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V12_REPORT_PATH,
    VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V12_PASS_VERDICT
  );
  if (!v12PrerequisiteResolved) {
    issues.push({
      code: 'PREREQ',
      message: 'PASS_VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V12 required',
      severity: 'error',
    });
  }
  ...
  const precheckPassed =
    v12PrerequisiteResolved && ontologyExists && capabilityModelExists && goalModelExists && lpmExists;
  ...
  if (precheckPassed) {
    ...
    writeJson(root, VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V13_PATH, {
      vertical_ai_project_truth_resolution_v13_id: 'vertical_ai_project_truth_resolution_v13',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_PHASE,
      ...
      vertical_ai_opportunity_identification_v12_prerequisite: v12PrerequisiteResolved,
      vertical_ai_opportunity_identification_v12_report_ref:
        VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V12_REPORT_PATH,
    });

    writeJson(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V13_PATH, {
      vertical_ai_brain_assist_evidence_v13_id: 'vertical_ai_brain_assist_evidence_v13',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    writeJson(root, VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V13_PATH, {
      vertical_ai_domain_opportunity_scores_v13_id: 'vertical_ai_domain_opportunity_scores_v13',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    writeJson(root, VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V13_PATH, {
      vertical_ai_selected_domain_opportunity_v13_id: 'vertical_ai_selected_domain_opportunity_v13',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    contractValidation = validateContracts({
      v12PrerequisiteResolved,
      reinvestmentCompletionIntegrated,
      projectTruthResolved: goalTruth.evaluated_goals > 0,
      brainAssistEvidencePresent: pathExists(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V13_PATH),
    ...
    if (contractValidation.aggregate_verdict !== 'PASS') {
      issues.push({
        ...
        message: 'One or more VAOI13 contracts failed',
        severity: 'error',
      });
    }
  }
  ...
  const verdict = passed
    ...
    : VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_FAIL_VERDICT;

  writeJson(root, VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_PATH, {
    vertical_ai_opportunity_identification_v13_id: 'vertical_ai_opportunity_identification_v13',
    architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
    phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_PHASE,
    generated_at: generatedAt,
    mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    decision_fingerprint: decisionFingerprint,
    selected_domain_id: selectedDomain?.domain_id ?? null,
    project_truth_ref: VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V13_PATH,
    brain_assist_evidence_ref: VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V13_PATH,
    domain_scores_ref: VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V13_PATH,
    selected_domain_ref: VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V13_PATH,
    lpm_mutation: false,
    brain_modification: false,
  });

  const report = {
    report_id: `vertical_ai_opportunity_identification_v13_${Date.now()}`,
    phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_PHASE,
    generated_at: generatedAt,
    mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    cycle_context: 'IMPLEMENTATION_CYCLE',
    goal: 'Select the highest-value eligible Vertical AI reinvestment domain.',
    vertical_ai_opportunity_identification_v13_passed: passed,
    final_verdict: verdict,
    status: passed
      ? VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_STATUS
      : 'VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_FAILED',
    decision_fingerprint: decisionFingerprint,
    ...
    domain_scores_ref: VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V13_PATH,
    selected_domain_ref: VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V13_PATH,
    identification_ref: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_PATH,
    domain_certifications: domainCertifications,
    reinvestment_completions: reinvestmentCompletions,
    ...
    checks: {
      ...
      V12_PREREQUISITE: v12PrerequisiteResolved,
      ...
      BRAIN_ASSIST_EVIDENCE_PRESENT: pathExists(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V13_PATH),
  ...
  writeJson(root, VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_REPORT_PATH, report);

  return {
    passed,
    verdict,
    reportPath: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V13_REPORT_PATH,
    selectedDomainId: selectedDomain?.domain_id ?? null,
  };
}
