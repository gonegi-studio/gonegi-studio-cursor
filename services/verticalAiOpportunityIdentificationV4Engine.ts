...
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_PHASE =
  'PHASE-VERTICAL-AI-OPPORTUNITY-IDENTIFICATION-V4' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_PASS_VERDICT =
  'PASS_VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_FAIL_VERDICT =
  'FAIL_VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_STATUS =
  'VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_COMPLETE' as const;

export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_DIR =
  'datasets/stage7/vertical_ai_opportunity_identification_v4' as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_DIR}/vertical-ai-opportunity-identification-v4.json` as const;
export const VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V4_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_DIR}/vertical-ai-project-truth-resolution-v4.json` as const;
export const VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V4_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_DIR}/vertical-ai-brain-assist-evidence-v4.json` as const;
export const VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V4_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_DIR}/vertical-ai-domain-opportunity-scores-v4.json` as const;
export const VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V4_PATH =
  `${VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_DIR}/vertical-ai-selected-domain-opportunity-v4.json` as const;
export const VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_REPORT_PATH =
  'reports/stage7/VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_REPORT.json' as const;

export const VAOI4_CONTRACT_IDS = [
  'VAOI4_PROJECT_TRUTH_RESOLVED',
  'VAOI4_BRAIN_ASSIST_EVIDENCE_PRESENT',
  'VAOI4_DOMAIN_SCORES_COMPUTED',
  'VAOI4_DOMAIN_CERTIFICATIONS_INTEGRATED',
  'VAOI4_HIGHEST_VALUE_DOMAIN_SELECTED',
  'VAOI4_EVIDENCE_BASED_DECISION',
] as const;
...
const EXECUTION_FLAGS = {
  vertical_ai_opportunity_identification_v4: true as const,
...
function validateContracts(input: {
  ...
  const results = [
    {
      contract_id: 'VAOI4_PROJECT_TRUTH_RESOLVED',
      verdict: input.projectTruthResolved ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI4_BRAIN_ASSIST_EVIDENCE_PRESENT',
      verdict: input.brainAssistEvidencePresent ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI4_DOMAIN_SCORES_COMPUTED',
      verdict: input.domainScoresComputed ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI4_DOMAIN_CERTIFICATIONS_INTEGRATED',
      verdict: input.domainCertificationsIntegrated ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI4_HIGHEST_VALUE_DOMAIN_SELECTED',
      verdict: input.highestValueDomainSelected ? 'PASS' : 'FAIL',
    },
    {
      contract_id: 'VAOI4_EVIDENCE_BASED_DECISION',
...
export function writeVerticalAiOpportunityIdentificationV4EngineReport(): {
  passed: boolean;
  verdict: string;
  reportPath: string;
  selectedDomainId: string | null;
  ...
  if (precheckPassed) {
    ...
    writeJson(root, VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V4_PATH, {
      vertical_ai_project_truth_resolution_v4_id: 'vertical_ai_project_truth_resolution_v4',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_PHASE,
    ...
    writeJson(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V4_PATH, {
      vertical_ai_brain_assist_evidence_v4_id: 'vertical_ai_brain_assist_evidence_v4',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    writeJson(root, VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V4_PATH, {
      vertical_ai_domain_opportunity_scores_v4_id: 'vertical_ai_domain_opportunity_scores_v4',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    writeJson(root, VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V4_PATH, {
      vertical_ai_selected_domain_opportunity_v4_id: 'vertical_ai_selected_domain_opportunity_v4',
      architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
      phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_PHASE,
      generated_at: generatedAt,
      mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    contractValidation = validateContracts({
      ...
      brainAssistEvidencePresent: pathExists(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V4_PATH),
    ...
    if (contractValidation.aggregate_verdict !== 'PASS') {
      issues.push({
        ...
        message: 'One or more VAOI4 contracts failed',
        severity: 'error',
      });
    }
  }
  ...
  const verdict = passed
    ? VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_PASS_VERDICT
    : VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_FAIL_VERDICT;

  writeJson(root, VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_PATH, {
    vertical_ai_opportunity_identification_v4_id: 'vertical_ai_opportunity_identification_v4',
    architecture_version: PROJECT_BRAIN_ARCHITECTURE_VERSION,
    phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_PHASE,
    generated_at: generatedAt,
    mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    ...
    decision_fingerprint: decisionFingerprint,
    selected_domain_id: selectedDomain?.domain_id ?? null,
    project_truth_ref: VERTICAL_AI_PROJECT_TRUTH_RESOLUTION_V4_PATH,
    brain_assist_evidence_ref: VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V4_PATH,
    domain_scores_ref: VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V4_PATH,
    selected_domain_ref: VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V4_PATH,
    lpm_mutation: false,
    brain_modification: false,
  });

  const report = {
    report_id: `vertical_ai_opportunity_identification_v4_${Date.now()}`,
    phase: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_PHASE,
    generated_at: generatedAt,
    mode: VERTICAL_AI_DEVELOPMENT_MODE_PROJECT_BRAIN_ASSISTED,
    cycle_context: 'IMPLEMENTATION_CYCLE',
    goal: 'Select the highest-value eligible Vertical AI domain from Current Project Truth.',
    vertical_ai_opportunity_identification_v4_passed: passed,
    final_verdict: verdict,
    status: passed
      ? VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_STATUS
      : 'VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_FAILED',
    decision_fingerprint: decisionFingerprint,
    ...
    domain_scores_ref: VERTICAL_AI_DOMAIN_OPPORTUNITY_SCORES_V4_PATH,
    selected_domain_ref: VERTICAL_AI_SELECTED_DOMAIN_OPPORTUNITY_V4_PATH,
    identification_ref: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_PATH,
    domain_certifications: domainCertifications,
    ...
    checks: {
      ...
      BRAIN_ASSIST_EVIDENCE_PRESENT: pathExists(root, VERTICAL_AI_BRAIN_ASSIST_EVIDENCE_V4_PATH),
  ...
  writeJson(root, VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_REPORT_PATH, report);

  return {
    passed,
    verdict,
    reportPath: VERTICAL_AI_OPPORTUNITY_IDENTIFICATION_V4_REPORT_PATH,
    selectedDomainId: selectedDomain?.domain_id ?? null,
  };
}
