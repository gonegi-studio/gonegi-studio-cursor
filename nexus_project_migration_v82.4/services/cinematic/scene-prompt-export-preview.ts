...
export const SCENE_PROMPT_EXPORT_PREVIEW_VERSION = CINEMATIC_PREVIEW_VERSION;

export type ScenePromptExportPreview = {
  version: typeof SCENE_PROMPT_EXPORT_PREVIEW_VERSION;
...
export function buildScenePromptExportPreview(): ScenePromptExportPreview {
  ...
  return Object.freeze({
    version: SCENE_PROMPT_EXPORT_PREVIEW_VERSION,
...
export function serializeScenePromptExportPreview(): string {
  const preview = buildScenePromptExportPreview();
