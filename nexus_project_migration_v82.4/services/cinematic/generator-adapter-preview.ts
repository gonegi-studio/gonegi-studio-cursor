...
export const GENERATOR_ADAPTER_PREVIEW_VERSION = CINEMATIC_PREVIEW_VERSION;

export type GeneratorAdapterPreview = {
  version: typeof GENERATOR_ADAPTER_PREVIEW_VERSION;
...
export function buildGeneratorAdapterPreview(): GeneratorAdapterPreview {
  ...
  return Object.freeze({
    version: GENERATOR_ADAPTER_PREVIEW_VERSION,
...
export function serializeGeneratorAdapterPreview(): string {
  const preview = buildGeneratorAdapterPreview();
