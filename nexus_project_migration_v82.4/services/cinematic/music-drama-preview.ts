...
export const MUSIC_DRAMA_PREVIEW_VERSION = CINEMATIC_PREVIEW_VERSION;

export type MusicDramaPreview = {
  version: typeof MUSIC_DRAMA_PREVIEW_VERSION;
...
export function buildMusicDramaPreview(): MusicDramaPreview {
  ...
  return Object.freeze({
    version: MUSIC_DRAMA_PREVIEW_VERSION,
...
export function serializeMusicDramaPreview(): string {
  const preview = buildMusicDramaPreview();
